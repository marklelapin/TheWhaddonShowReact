...
class ResultsTable extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            dateFrom: new Date("2023-09-01"), //new Date().setDate(new Date().getDate() - 7),
    ...
    render() {
        ...
        return (
            <Query queryKey={["apiTestResults"]} queryFn={() => fetchData(`/apimonitor/results/?dateFrom=${this.state.dateFrom}&dateTo=${this.state.dateTo}`)} queryOptions={{}}>
