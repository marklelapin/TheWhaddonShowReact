...
export const part4 = Object.freeze({ id: 'p4', created: createdDate, name: 'Part 4', tags: ['blue', 'cyan'], personId: null, isActive: true, updatedOnServer: null })
export const part5 = Object.freeze({ id: 'p5', created: createdDate, name: 'Part 5', tags: ['blue', 'cyan'], personId: null, isActive: true, updatedOnServer: null })
...
export const initialStage1 = Object.freeze({ id: 'si1is', created: createdDate, type: INITIAL_STAGING, text: 'Initial Stage 1', nextId: 'si1ic', previousId: 'si1s', partIds: [], parentId: 's1', isActive: true, updatedOnServer: null })
export const initialCurtain1 = Object.freeze({ id: 'si1ic', created: createdDate, type: INITIAL_CURTAIN, text: 'Initial Curtain 1', nextId: 'si11', previousId: 'si2is', partIds: [], parentId: 's1', isActive: true, updatedOnServer: null })
export const dialogue11 = Object.freeze({ id: 'si11', created: createdDate, type: DIALOGUE, text: 'Dialogue 1:1', nextId: 'si12', previousId: 'si1ic', partIds: ['p1'], parentId: 's1', isActive: true, updatedOnServer: null })
...
export const dialogue13 = Object.freeze({ id: 'si13', created: createdDate, type: DIALOGUE, text: 'Dialogue 1:3', nextId: 'si14', previousId: 'si12', partIds: ['p3'], parentId: 's1', isActive: true, updatedOnServer: null })
export const dialogue14 = Object.freeze({ id: 'si14', created: createdDate, type: DIALOGUE, text: 'Dialogue 1:4', nextId: null, previousId: 'si13', partIds: ['p1', 'p2', 'p3'], parentId: 's1', isActive: true, updatedOnServer: null })

export const synopsis2 = Object.freeze({ id: 'si2s', created: createdDate, type: SYNOPSIS, text: 'Synopsis 2', nextId: 'si2ic', previousId: 's2', partIds: [], parentId: 's2', isActive: true, updatedOnServer: null })
export const initialStage2 = Object.freeze({ id: 'si2is', created: createdDate, type: INITIAL_STAGING, text: 'Initial Stage 2', nextId: 'si2ic', previousId: 'si2s', partIds: [], parentId: 's2', isActive: true, updatedOnServer: null })
export const initialCurtain2 = Object.freeze({ id: 'si2ic', created: createdDate, type: INITIAL_CURTAIN, text: 'Initial Curtain 2', nextId: 'si21', previousId: 'si2is', partIds: [], parentId: 's2', isActive: true, updatedOnServer: null })
...
export const dialogue24 = Object.freeze({ id: 'si24', created: createdDate, type: DIALOGUE, text: 'Dialogue 2:4', nextId: 'si25', previousId: 'si23', partIds: ['p4', 'p5', 'p6'], parentId: 's2', isActive: true, updatedOnServer: null })
...
export const initialStage3 = Object.freeze({ id: 'si3is', created: createdDate, type: INITIAL_STAGING, text: 'Initial Stage 3', nextId: 'si3ic', previousId: 'si3s', partIds: [], parentId: 's3', isActive: true, updatedOnServer: null })
export const initialCurtain3 = Object.freeze({ id: 'si3ic', created: createdDate, type: INITIAL_CURTAIN, text: 'Initial Curtain 3', nextId: 'si31', previousId: 'si3is', partIds: [], parentId: 's3', isActive: true, updatedOnServer: null })
...
export const initialStage7 = Object.freeze({ id: 'si7is', created: createdDate, type: INITIAL_STAGING, text: 'Initial Stage 7', nextId: 'si7ic', previousId: 'si7s', partIds: [], parentId: 's7', isActive: true, updatedOnServer: null })
...
export const mockSceneOrders = {
    ...
    's1': [scene1,synopsis1, initialStage1, initialCurtain1, dialogue11, dialogue12, dialogue13, dialogue14],
    's2': [scene2,synopsis2, initialStage2, initialCurtain2, dialogue21, dialogue22, dialogue23, dialogue24, dialogue25],
    's3': [scene3,synopsis3, initialStage3, initialCurtain3,dialogue31,dialogue32,dialogue33,dialogue34],
    //'s4': [],
    //'s5': [],
    //'s6': [],
